...
<div class="relative w-full bg-white dark:bg-gsm-dark"
    ...
    <style>
        ...
        .animate-slam {
            animation: slam-down 1.5s cubic-bezier(0.22, 1, 0.36, 1) forwards;
        }
    </style>
    ...
    <header class="absolute inset-0 flex items-center justify-center font-sans z-10 animate-slam overflow-hidden"
        ...
        <div class="relative z-10 text-center text-white px-4 max-w-5xl mx-auto mt-10">
            ...
            <h1 class="text-4xl md:text-7xl font-bold font-sans mb-8 uppercase tracking-tight leading-none drop-shadow-lg">
                KABINET <span class="text-hmj-gold dark:text-white relative inline-block group cursor-default">
                    SWARNADIPA
                    <span class="absolute bottom-0 left-0 w-full h-1 bg-hmj-gold dark:bg-white transform scale-x-0 transition-transform duration-500 group-hover:scale-x-100 origin-left"></span>
                </span> ARDHANA
            </h1>

            <p class="text-lg md:text-2xl text-gray-200 mb-10 font-display italic max-w-3xl mx-auto opacity-90 text-shadow-sm">
